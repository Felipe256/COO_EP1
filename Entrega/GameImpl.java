...
public class GameImpl implements Game{
	...
	/**
	 * Metodo que inicializa todas as posições do tabuleiro e coloca as peças em seu devido lugar
	 * */
	...
	/**
	 * Metodo que inicializa os jogadores, o turno e a carta da mesa
	 * @param gameCards Vetor das cartas selecionadas para a partida
	 * @param namePlayerRed Nome do jogador Vermelho
	 * @param namePlayerBlue Nome do jogador Azul
	 */
    ...
    /**
     * Método que move uma peca
     * @param card A carta de movimento que sera usada
	...
	/**
	 * Metodo que imprime o tabuleiro, de quem é o turno e as cartas de cada jogador e a carta da mesa
	 */
	...
	/**
	 * Metodo que muda o turno dos jogadores
	 */
	...
	/**
	 * Metodo que devolve de quem e a vez
	 * @return Color que diz de quem e a vez
	 */
	...
	/**
	 * Metodo que imprime as cartas dos jogadores e a carta da mesa
	 */
	...
	/**
	 * Metodo que imprime uma mensagem relacionada com as cartas recebidas e seus respectivos nomes
	 * @param cards vetor de Card para ser impresso
	 * @param typeCards String que será impresso antes do nome das cartas
	 */
